package exercise12_2_test

import (
	"fmt"
	"github.com/chibby0ne/go_book_exercises/chapter12/exercise12_2"
	"testing"
)
...
func TestDisplayStruct(t *testing.T) {
	...
	exercise12_2.Display("strangelove", strangelove)
...
func TestMapKeys(t *testing.T) {
	...
	exercise12_2.Display("mmm", mmm)

}

func TestDisplayCiclicDataStructure(t *testing.T) {
	type Cycle struct {
		Value int
		Tail  *Cycle
	}
