// Ex. 8.5 Take an existing CPU-bound sequential program, such as the
// Mandelbrot program of section 3.3. or the 3-d surface computation of section
// 3.2 and execute its main loop in parallel using channels for communication.
// how much faster does it run on a multiprocessor machine? What is he optimal
